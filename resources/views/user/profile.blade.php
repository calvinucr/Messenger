					...
					<div class="row">
						...
						<div class="col-lg-8">
							<div class="row">
								...
								<div class="col-lg-2 padding-reset"><input class="btn btn-default cancel-info-edit" value="Cancel" type="reset"></div>
								<div class="col-lg-2 padding-reset">
									<input class="btn btn-primary info-edit" value="Edit" type="button">
